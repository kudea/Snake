...
del Snake.lst	REM Snake可以替換成.asm檔的檔名
del Snake.obj
del Snake.ilk
del Snake.pdb
del Snake.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:Snake.exe Snake.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
